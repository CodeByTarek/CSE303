# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 23:14:13 2021
...
model.fit(X, y)              # X and y is from train Dataset...

#%%
# Prediction Value..
y_pred=model.predict(X)   #Prediction for X..here X is from Train Dataset...
...
model = LogisticRegression(solver='newton-cg',C=1,penalty='l2',tol=0.0001)
...
fpr, tpr, threshold1 = roc_curve(y, y_proba)
print('roc_auc_score for Logistic Regression: ', roc_auc_score(y, y_proba))
...
y_pred_test=model.predict(test_data)   #Prediction for X..here X is from Test Dataset...
...
submission.to_csv('Sample Submission For Model 1.csv',index=False)
